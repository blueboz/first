package cn.boz.nettystd.nettyorder.cli;

import java.net.InetSocketAddress;

import cn.boz.nettystd.nettyorder.cli.handler.EchoClientHandler;
import cn.boz.nettystd.nettyorder.cli.handler.EchoClientHandler2;
...
public class NettyCli {
	...
	public NettyCli(String host, int port) {
		this.host = host;
		this.port = port;
	}
	...
	public static void main(String[] args) throws Exception {
		new NettyCli("localhost", 20000).start();
	}
}
